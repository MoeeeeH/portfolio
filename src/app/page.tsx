...
export default function Home() {
  ...
  const skills = [
    ...
    { 
      ...
      items: ["Python", "Bash", "PowerShell", "JavaScript", "C/C++", "Go", "Rust", "SQL"],
    ...
    { 
      category: "Cloud", 
      items: ["AWS", "Azure", "GCP", "Container Security", "Cloud Architecture", "Serverless", "Kubernetes", "Terraform", "CI/CD Pipelines", "Infrastructure as Code"],
      description: "Cloud security expertise across major providers with focus on secure architecture and DevSecOps practices"
    },
  ];
  ...
  const certifications = [
    ...
    },
    {
      ...
      description: "Specialized security knowledge for AWS environments including identity management, infrastructure protection, and data encryption",
      icon: "/aws.png"
    },
    {
      id: 4,
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="mt-12 text-center animate-fadeInUp" style={{ animationDelay: "0.5s" }}>
                ...
                <div className="flex justify-center space-x-6">
                  <a href="https://linkedin.com/in/mohamed-hassen" target="_blank" rel="noopener noreferrer" className="w-14 h-14 rounded-full bg-[rgba(0, 60, 120, 0.3)] flex items-center justify-center hover:bg-[rgba(0, 129, 212, 0.5)] transition-all duration-300 transform hover:scale-110 hover:shadow-lg hover:shadow-[rgba(0, 129, 212, 0.3)]">
                  ...
                  <a href="https://twitter.com/mohamedhassen" target="_blank" rel="noopener noreferrer" className="w-14 h-14 rounded-full bg-[rgba(0, 60, 120, 0.3)] flex items-center justify-center hover:bg-[rgba(0, 129, 212, 0.5)] transition-all duration-300 transform hover:scale-110 hover:shadow-lg hover:shadow-[rgba(0, 129, 212, 0.3)]">
                    <svg className="w-8 h-8 text-[#81d4fa]" viewBox="0 0 24 24" fill="currentColor">
